...
[env]
# default = "dev"      # fallback environment
...
[barrier]
# ttl_secs = 3600  # production barrier token lifetime

[materialize]
# dir_prefix = false
# path_prefix = false

# Deactivated example rules (uncomment to use):
# [[materialize.rule]]
# action = "allow"
...
# [[run.rule]]
# action = "allow"
# path = ".gitvault/store/prod/**/*.json.age"
# keys = ["SERVICE_*", "TOKEN_*"]
# dir_prefix = false
# path_prefix = true
...
mod tests {
    ...
    fn test_init_creates_config() {
        ...
        assert!(
            content.contains("# [[seal.rule]]"),
            "config should include commented seal.rule example"
        );
        assert!(
            content.contains("# [[materialize.rule]]"),
            "config should include commented materialize.rule example"
        );
        assert!(
            content.contains("# [[run.rule]]"),
            "config should include commented run.rule example"
        );
    }
